...
<html lang="en">
 ...
 ?>                     
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fname']);?>'s Profile</h4>
...
<div class="col-sm-4">
<input type="text" name="fname" required="required" value="<?= $userinfo['full_name'] ?>" class="form-control" >
 </div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Lname</label>
 <div class="col-sm-4">
<input type="text" name="lname" required="required" value="<?= $userinfo['gender'] ?>" class="form-control">
</div>
