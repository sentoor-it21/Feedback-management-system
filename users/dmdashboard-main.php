...
<?php include("dmuser.php");?>
      <section id="main-content">
        ...
        $rt = mysqli_query($conn,"SELECT * FROM users where id='".$_SESSION['id']."");
...
{?>
                  ...
                  <span class="li_news"></span>
                    <?php 
  $status="in Process";                   
$rt = mysqli_query($con,"SELECT * FROM users where userId='".$_SESSION['id']."' and  status='$status'");
$num1 = mysqli_num_rows($rt);
{?>
                  <h3><?php echo htmlentities($num1);?></h3>
                        </div>
