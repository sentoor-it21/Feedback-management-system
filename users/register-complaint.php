...
include('includes/dmsidebar.php');
...
$query=mysqli_query($conn,"insert into tblcomplaints(userId,category,subcategory,complaintType,state,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$compfile')");
...
<html lang="en">
  <head>
    ...
    <title>GRP | User Register Complaint</title>
...
function getCat(val) {
  ...
  <section id="container" >
     <?php include("includes/header.php");?>
      <?php include("includes/dmsidebar.php");?>
...
<?php $sql=mysqli_query($conn,"select stateName from state ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
